...
function stateChanged() { 
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == 200) {
        ...
        if(jsonstr[3] == "n") {
            ...
            document.getElementById("user-favourite-type").innerHTML += user[0].favourite_type;
            document.getElementById("user-image").src = user[0].image_addr;
            ...
            var user_book = JSON.parse(jsonstr);
            ...
            document.getElementById("user-favourite-type").innerHTML += user_book[0].favourite_type;
            document.getElementById("user-image").src = user_book[0].image_addr;

            if(user_book.length == 1) {
                ...
                document.getElementById("user-book2-cover").src = user_book[user_book.length-2].cover_addr;
                document.getElementById("user-book2-title").innerHTML = user_book[user_book.length-2].title;
                document.getElementById("user-book3-cover").src = user_book[user_book.length-3].cover_addr;
                document.getElementById("user-book3-title").innerHTML = user_book[user_book.length-3].title;
            }
        }
    }
}
